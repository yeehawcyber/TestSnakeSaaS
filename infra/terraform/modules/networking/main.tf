...
# A single NAT gateway is an intentional dev cost tradeoff. Production must use
# one gateway per AZ or another highly available egress design in a separate root.
